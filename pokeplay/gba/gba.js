function GameBoyAdvance() {
	...
	this.multiplier = 1; // Default speed multiplier
...
GameBoyAdvance.prototype.storeSavedata = function() {
	...
	try {
		...
		console.log('[GBA] SRAM Saved:', this.SYS_ID + '.' + this.mmu.cart.code);
	} catch (e) {
...
GameBoyAdvance.prototype.retrieveSavedata = function() {
	try {
		...
		if (data) {
			...
			console.log('[GBA] SRAM Retrieved:', this.SYS_ID + '.' + this.mmu.cart.code);
			return true;
		}
	} catch (e) {
